...
export default function EditOptionStrategyPage() {
    ...
    const handleUpdate = async (data: any) => {
        const { strategiesAPI } = await import('@/lib/api');
        await strategiesAPI.option.update(id, data);
        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-20">
            <div className="max-w-4xl mx-auto px-4 py-8">
                ...
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <h1 className="text-2xl font-bold dark:text-white">Edit Option Strategy</h1>
                </div>

                <OptionStrategyForm mode="edit" initialData={strategy} onSave={handleUpdate} />
            </div>
        </div>
    );
}
